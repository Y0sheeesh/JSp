<%-- 
    ...
    Created on : 5/04/2022, 04:59:17 PM
    Author     : Alumno
--%>
...
<html>
    ...
    <body>
        ...
        <form mehod="post" name="editar" action="actualizaralumno.jsp">
        ...
        <%
            ...
            try{
                ...
                try{
                   ...
                   String q="select *from alumnobatiz order by boleta asc" + "where boleta="+id;
                   ...
                   while(rs.next()){
                    ...
                    <br>
                    <input type="text" name="apat2" value="<%=rs.getString("appat")%>">
                    <br>
